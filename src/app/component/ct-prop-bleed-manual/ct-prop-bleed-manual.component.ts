...
@Component({
  selector: 'app-ct-prop-bleed-manual',
  templateUrl: './ct-prop-bleed-manual.component.html',
  styleUrls: ['./ct-prop-bleed-manual.component.css']
})
export class CtPropBleedManualComponent implements OnInit {
  CHEM: String;
  LOL: string;
  CD: number;
  INHIBT: string;
      ...
      if(this.PFR){
        switch (this.PFR) {
          ...
          default:
            ...
            this.SecondPerContact = (0.72*Number(this.AFR)*Number(this.AdjGalPerContact)/(Number(this.CD)*Number(this.AdjPO)));
            break;
