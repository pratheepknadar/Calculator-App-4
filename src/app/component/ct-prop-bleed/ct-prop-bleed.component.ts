...
@Component({
  selector: 'app-ct-prop-bleed',
  templateUrl: './ct-prop-bleed.component.html',
  styleUrls: ['./ct-prop-bleed.component.css']
})
export class CtPropBleedComponent implements OnInit {
